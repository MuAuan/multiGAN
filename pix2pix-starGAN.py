...
def my_train(args):
    ...
    generator_model.load_weights('params_generator6_pix_epoch_1100.hdf5')
    # load discriminator model
    discriminator_model = models.my_load_DCGAN_discriminator(img_shape, disc_img_shape, patch_num)
    discriminator_model.load_weights('params_discriminator6_pix_epoch_1100.hdf5')
...
def main():
    ...
    parser.add_argument('--datasetpath14', '-d_test4', type=str, default ="naki2henRaw_test.hdf5")   #, required=True)
    parser.add_argument('--datasetpath15', '-d_test5', type=str, default ="hen2sugaoRaw_test.hdf5")   #, required=True)
