...
def main():
    ...
    parser.add_argument('--datasetpath00', '-d_train0', type=str, default ="airp2nekoRaw_train.hdf5")  #,  "required=True)
    parser.add_argument('--datasetpath01', '-d_train1', type=str, default ="boy2airpRaw_train.hdf5")  #,  "required=True)
    parser.add_argument('--datasetpath02', '-d_train2', type=str, default ="boy2nekoRaw_train.hdf5")  #,  "required=True)
    parser.add_argument('--datasetpath10', '-d_test0', type=str, default ="airp2nekoRaw_test.hdf5")   #, required=True)
    parser.add_argument('--datasetpath11', '-d_test1', type=str, default ="boy2airpRaw_test.hdf5")   #, required=True)
    parser.add_argument('--datasetpath12', '-d_test2', type=str, default ="boy2nekoRaw_test.hdf5")   #, required=True)
